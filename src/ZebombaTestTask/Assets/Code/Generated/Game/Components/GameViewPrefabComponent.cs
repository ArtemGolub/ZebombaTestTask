...
public partial class GameEntity {
    ...
    public Code.Infrastructure.Views.GameEntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(Code.Infrastructure.Views.GameEntityBehaviour newValue) {
    ...
    public GameEntity ReplaceViewPrefab(Code.Infrastructure.Views.GameEntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Code.Common.ViewPrefab)CreateComponent(index, typeof(Code.Common.ViewPrefab));
        component.Value = newValue;
